class Retangulo():
    ...
    def calc_area(self, pisos):
        ...
        print(f"Area igual a {self.area} a quantidade de pisos necessarios será {self.area / pisos}")
    
    def calc_perimetro(self, rodape):
        self.perimetro =  self.ladoA + self.ladoB
        print(f"Perimetro igual a {self.perimetro} a quantidade de rodapé necessarios será {self.perimetro / rodape}")
